...
// updateMovieHandler() supports GET HTTP method for showing a single movie resource.
...
// Deletes a movie from DB for given id.
...
func (app *application) listMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	// qs contains url.Values map containing query string data.
	qs := r.URL.Query()
